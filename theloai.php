...
<div id="main">
    <div id="contents">
        ...
        <?php 
			$menu=mysql_query("select * from chude order by id desc");
	...
	<div class="list_song" style="padding: 10px;">
		<div class="left">
			<div class="left images">
            	<img src="image/giaodien/one.jpg" class="img" height="100px" width="100px">
            </div>
			
			<p class="singer">Thể Loại: 
				<a title="Thể Loại <?php echo $row['chude']; ?>" ><?php echo $row['chude']; ?></a>
			</p>
